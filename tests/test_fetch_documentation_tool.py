...
def mock_fetcher():
    ...
    mock.health_check = AsyncMock(return_value={
        ...
        "services": {
            ...
            "specification": {"status": "healthy", "url": "https://www.ilograph.com/docs/spec/"}
        },
        "cache_stats": {
            "total_entries": 3,
            "valid_entries": 3,
...
class TestCheckDocumentationHealth:
    ...
    async def test_health_check_degraded(self, mock_fetcher):
        ...
        mock_fetcher.health_check = AsyncMock(return_value={
            ...
            "services": {
                "documentation": {"status": "healthy", "url": "https://www.ilograph.com/docs/"},
                "specification": {"status": "unhealthy", "url": "https://www.ilograph.com/docs/spec/", "error": "Connection timeout"}
            },
...
class TestToolIntegration:
    ...
    async def test_all_tools_registered(self):
        ...
        async with Client(mcp_server) as client:
            ...
            assert "Fetches and formats narrative documentation from Ilograph website" in fetch_tool.description
    ...
    async def test_workflow_list_then_fetch(self, mock_fetcher):
        ...
        with patch('ilograph_mcp.tools.register_fetch_documentation_tools.get_fetcher', return_value=mock_fetcher):
            ...
            async with Client(mcp_server) as client:
                ...
                fetch_result = await client.call_tool("fetch_documentation_tool", {"section": "tutorial"})
